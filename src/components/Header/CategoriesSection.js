...
export function CategoriesSection(props){
    return (
        <div className="d-flex flex-wrap justify-content-center py-2 categories">
            ...
            <CategoryDiv isActive={props.activeIndex===1} toggle={() => props.toggle(1)} category="MEN" stock="4" />
            ...
            <CategoryDiv isActive={props.activeIndex===4} toggle={() => props.toggle(4)} category="WOMEN" stock="151" />
        </div>
    )
}